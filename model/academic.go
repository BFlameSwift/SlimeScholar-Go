...
type PaperReference struct {
	...
	PaperTitle          string `gorm:"type:string" json:"paper_title"`
	ReferencePaperTitle string `gorm:"type:string" json:"reference_paper_title"`
}
